...
DROP TABLE IF EXISTS `User_Favorite_Location`;
DROP TABLE IF EXISTS `User_Favorite_Artist`;
DROP TABLE IF EXISTS `Event_Save`;
DROP TABLE IF EXISTS `Event_Artist`;
DROP TABLE IF EXISTS `Artist_Genre_Tag`;
DROP TABLE IF EXISTS `Genre_Tag`;
...
INSERT INTO `Genre_Tag` (`label`) VALUES ('Punk'),('Ska'),('Electro'),('Indie'),('Folk'),('Metal'),('Rap'),('Jazz'),('Rock'),('Musette'),('Pop'),('Alternative'),('Blues'),('Classical'),('Reggae'),('Experimental'),('Ambient'),('House'),('Techno'),('R&B'),('Soul'),('Hardcore'),('Crust'),('Militant'),('Queer'),('Gothic'),('Industrial'),('Post'),('Progressive'),('Ambient'),('Dub'),('Psychedelic'),('New Wave'),('Synthwave'),("Synth'"),('Grunge'),('Dubstep'),('Trap'),('Hardstyle'),('Funk'),('Country'),('Jungle'),('Metalcore'),('Shoegaze'),('Trip-Hop'),('Breakbeat'),('Garage'),('K-Pop'),('Reggaeton'),('Tango'),('Chiptune'),('Death'),('Black'),('Doom'),('Emo'),('Noise');
...
INSERT INTO `Artist_Genre_Tag` (`artist_id`, `genre_tag_id`) VALUES (1, 1),(1, 2),(1, 25),(2, 1),(2,24),(2, 22),(2, 23),(2,25),(3, 1),(3, 10),(4, 15),(4, 2),(5, 15),(5, 2),(6, 1),(6, 3),(7, 6),(7, 15),(8, 1),(9, 1),(9, 23),(10, 1),(11, 25),(11,3),(12, 1),(12, 24),(13, 25),(13,3),(14, 1),(14, 3),(14, 25),(15, 10),(16, 1),(16, 24),(16, 25), (17, 1),(17, 9),(18, 1),(18, 10),(19, 1),(19, 2),(20, 1), (20, 2), (21, 1), (21, 2), (21, 22),(22, 1), (22, 23), (22, 25),(23, 2),(24, 2), (25, 1);
...
INSERT INTO `User_Location` (`user_id`, `location_id`) VALUES (1, 5),(2, 8),(3, 12),(4, 3),(5, 15),(6, 7),(7, 10),(8, 1),(9, 4),(10, 14),(11, 11),(12, 6),(13, 13),(14, 9),(15, 2),(6, 1),(6, 3),(6, 7),(6, 10),(6, 12);
